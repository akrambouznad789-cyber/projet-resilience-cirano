...
![Superposition des 4 méthodes DJMA](figures/carte_3d_divergence_methodes.png)

Plutôt qu'une simple comparaison statistique, cette carte empile le réseau routier en 4 plateaux (m1 à m4, bas → haut) : la couleur encode le DJMA (échelle log commune aux 4 plateaux), et l'épaisseur du trait — identique sur les 4 plateaux — encode l'écart relatif entre méthodes pour cet arc. Un arc homogène reste fin et de teinte stable d'un plateau à l'autre ; un arc où les méthodes divergent devient une ligne épaisse qui traverse visuellement toute la pile, soulignée par un connecteur vertical pointillé pour les 10 arcs les plus divergents. Les écarts les plus marqués se situent sur des tronçons courts à faible nombre de segments contributeurs, où un seul segment extrême pèse beaucoup plus sur m4 (percentile) que sur m1-m3 (moyennes) : Laurier-Station–Saint-Apollinaire (156 %), L'Ancienne-Lorette–Nœud Lac-St-Jean (147 %), Donnacona–Saint-Augustin-de-Desmaures (142 %).
